...
public class Constants {
	...
	static class Fields {
		...
		public static final String PRESSAO_BAIXA = "Pressão Baixa";	
		public static final String PRESSAO_ALTA = "Pressão Alta";
	 ...
	 * class, they could also have been coded directly in the modele
	 */
